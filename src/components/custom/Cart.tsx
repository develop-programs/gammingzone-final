    ...
    <Sheet>
      ...
      <SheetContent side="right">
        <SheetHeader>
          ...
          <SheetDescription>Cart items</SheetDescription>
        </SheetHeader>
        <div className="grid h-[calc(100vh-10rem)]">
          <div className="w-full flex justify-end">
            <SheetClose asChild>
              <Link
                href="/cart"
                className="text-sm hover:underline hover:underline-offset-2 font-semibold"
              >
                view more
              </Link>
            </SheetClose>
        ...
        <SheetFooter className="absolute bottom-0 left-0 w-full justify-between p-2">
