                    ...
                    <div className="flex gap-6 items-center">
                        <Popover>
                            <PopoverTrigger asChild>
                                <Button
                                    className="bg-orange-600 hover:bg-orange-600/90 rounded-md text-white hover:text-white">
                                    All Categories
                                    <ChevronDownIcon/>
                                </Button>
                            </PopoverTrigger>
                            <PopoverContent className="grid max-w-max" align={"start"} side="bottom" sideOffset={15}>
                                {[
                                    ...
                                    <Link
                                        href=""
                                        key={index}
                                        className="text-sm hover:bg-slate-200/70 p-2 rounded-md font-semibold"
                                    >
                                        {item}
                                    </Link>
                                ))}
